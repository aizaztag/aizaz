...
<div class="container">
    ...
    <!-- Upload  -->
    <form id="file-upload-form" class="uploader" action="/image/{{$image->id}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <input id="file-upload" type="file" name="fileUpload" accept="image/*" onchange="readURL(this);">
        <input id="extension" type="text" name="extension" value="{{$image->extension}}">
